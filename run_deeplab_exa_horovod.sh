...
#cp /home/rubenh/projects/deeplab/models/research/deeplab/CAMELYON16_PREPROCESSING/Processed/patch-based-classification_1024/tf-records/* /home/rubenh/projects/deeplab/models/research/deeplab/datasets/camelyon16/tfrecord/
...
# Train 10 iterations.
NUM_ITERATIONS=300 #18750 # ~30 000 images / batch size 24 = 1250 * 15 epochs = 18750
NAS_SESSION="False"
...
then
    ...
    horovodrun -np 16 -H server1:4,server2:4,server3:4,server4:4 python3 "${WORK_DIR}"/train.py \
        --num_clones=2 \
