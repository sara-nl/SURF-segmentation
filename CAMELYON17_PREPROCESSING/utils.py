...
DATA_DIR = '/home/rubenh/projects/deeplab/models/research/deeplab/CAMELYON16_PREPROCESSING/'

TUMOR_WSI_PATH = '/nfs/managed_datasets/CAMELYON16/TrainingData/Train_Tumor'
NORMAL_WSI_PATH = '/nfs/managed_datasets/CAMELYON16/TrainingData/Train_Normal'
TUMOR_MASK_PATH = '/nfs/managed_datasets/CAMELYON16/TrainingData/Ground_Truth/Mask'
TEST_WSI_PATH = '/nfs/managed_datasets/CAMELYON16/Testset'
...
TRAIN_TF_RECORDS_DIR_LIST = {
    ...
    'rubenh': DATA_DIR + 'Processed/patch-based-classification_704_Normalized/tf-records/'
}
